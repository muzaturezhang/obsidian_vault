...
---
如何科研训练自己
训练写literature review 和introduction

---
英语论文写作，常用词语积累（eg. adv. substantially）
...
---
机器学习的实验设计也需要保证公平，像生物一样，因为它也具有随机性。。。

---
对于chat gpt等大语言模型的使用还是不熟练全面！（比如不知道某些按钮的意思），一定要在没事的时候学了！